...
async function populate() { 
    ...
    const requestURL = 'https://raw.githubusercontent.com/Nineikro/testing-json/main/kanji.json?token=GHSAT0AAAAAACDJPAEFFMBA34B7XEXHZ22UZEY4GAA';
...
function populateHeroes(obj) {
  ...
  for (const block of blocks) { //loops through all the parts; meaning: shows all the parts till theres no more
    ...
    const songLines = block.powers; //JSON lyrics stored in songLines
